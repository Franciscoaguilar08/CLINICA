            ...
            <div className="lg:grid lg:grid-cols-12 gap-16 items-center">
                <div className="lg:col-span-6 mb-12 lg:mb-0 text-center lg:text-left">
                    ...
                    <p className="text-xl text-slate-600 mb-10 leading-relaxed max-w-2xl mx-auto lg:mx-0">
                        La primera plataforma de prevenci├│n secundaria dise├▒ada para la realidad de LatAm: donde <strong>la falta de datos es el dato m├ís fuerte.</strong> Reduzca internaciones priorizando a quien dej├│ de venir.
                    </p>
                            ...
                            <div className="p-6 space-y-4">
                                <div className="flex justify-between items-center mb-6">
                                    ...
                                    <div className="bg-red-50 text-red-600 px-3 py-1 rounded-lg text-xs font-bold border border-red-100 flex items-center gap-1">
                                        <AlertTriangle size={12} /> RIESGO CR├ìTICO
                                    </div>
                                </div>
                                
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="bg-white p-4 rounded-lg border border-slate-200 shadow-sm">
                                        <div className="text-xs text-slate-400 font-bold uppercase mb-2">Predicci├│n IA</div>
                                        <div className="text-2xl font-bold text-slate-800">88%</div>
                                        <div className="text-xs text-slate-500 mt-1">Prob. Internaci├│n 30d</div>
                                    </div>
                                    <div className="bg-white p-4 rounded-lg border border-red-100 shadow-sm relative overflow-hidden">
                                        ...
                                        <div className="text-xs text-slate-500 mt-1">Sin consulta {'>'} 180 d├¡as</div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-blue-50 p-4 rounded-lg border border-blue-100 flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs text-blue-600">8 f├írmacos activos ÔÇó Riesgo Renal</div>
                                    </div>
                                </div>
                            </div>
                         </div>
      ...
      <div className="bg-slate-900 py-24 text-white">
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-16">
                <h2 className="text-blue-400 font-bold tracking-wider uppercase text-sm mb-3">La Diferencia T├®cnica</h2>
                <h3 className="text-3xl md:text-4xl font-bold mb-6">Un Motor de Riesgo dise├▒ado para datos imperfectos.</h3>
                <p className="text-slate-400 text-lg leading-relaxed">
                    Los modelos tradicionales fallan en LatAm porque esperan historias cl├¡nicas completas. 
                    Abk Clinical utiliza la <strong>ausencia de informaci├│n</strong> como el predictor m├ís fuerte de riesgo.
                </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
                <div className="bg-slate-800 p-8 rounded-2xl border border-slate-700 hover:border-blue-500 transition-colors group">
                    ...
                    <p className="text-slate-400">
                        Si un paciente cr├│nico no consume recetas ni asiste a consulta, su riesgo es cr├¡tico. Nuestro algoritmo detecta el "abandono silencioso" antes de la guardia.
                    </p>
                </div>
                ...
                <div className="bg-slate-800 p-8 rounded-2xl border border-slate-700 hover:border-amber-500 transition-colors group">
                    ...
                    <h4 className="text-xl font-bold mb-3">Escudo Farmacol├│gico</h4>
                    <p className="text-slate-400">
                        Auditor├¡a autom├ítica de polifarmacia. Detectamos cascadas de prescripci├│n, dosis inadecuadas para la funci├│n renal y duplicidades terap├®uticas en tiempo real.
                    </p>
                </div>
                ...
                <div className="bg-slate-800 p-8 rounded-2xl border border-slate-700 hover:border-emerald-500 transition-colors group">
                    ...
                    <p className="text-slate-400">
                        Transforme la gesti├│n cl├¡nica en m├®tricas financieras. Dashboard en vivo de internaciones evitadas, reducci├│n de re-ingresos y ahorro proyectado.
                    </p>
                </div>
            </div>
         </div>
      ...
      <div className="bg-white border-t border-slate-100 py-16">
          <div className="max-w-4xl mx-auto px-4 text-center">
              ...
              <p className="text-lg text-slate-600 mb-8">
                  ├Ünase a la red de prevenci├│n secundaria m├ís avanzada de la regi├│n.
              </p>
              <button 
                  onClick={onEnter}
        ...
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
            <div className="max-w-md w-full bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden">
                <div className="bg-slate-900 p-6 text-center">
                    ...
                    <p className="text-slate-400 text-sm mt-1">Acceso Seguro a Plataforma Cl├¡nica</p>
                </div>
                ...
                <div className="p-8">
                    ...
                    <div className="flex bg-slate-100 p-1 rounded-lg mb-8">
                        ...
                        >
                            <Stethoscope size={16} /> Soy M├®dico
                        </button>
                        <button 
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            <label className="block text-sm font-medium text-slate-700 mb-2">
                                {role === 'doctor' ? 'Matr├¡cula Profesional (M.N. / M.P.)' : 'ID Corporativo / Legajo'}
                            </label>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            ...
            <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm flex flex-col">
                <span className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-1">Reducci├│n Re-ingresos</span>
                <div className="flex items-center gap-2 text-blue-600">
                    <TrendingDown size={24} />
                    <span className="text-2xl font-bold">{OUTCOMES_DATA.readmissionsReducedPercentage}%</span>
                </div>
                <span className="text-xs text-blue-600/80 font-medium mt-1">vs. Promedio Hist├│rico</span>
            </div>
        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm flex flex-col justify-center items-center text-center">
                     <div className="text-xs font-bold uppercase text-slate-400 mb-2">Score (Internaci├│n 30d)</div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
                    <h3 className="font-bold text-slate-800 mb-6 flex items-center gap-2">
                        <TrendingUp size={18} className="text-blue-600" /> Proyecci├│n de Riesgo a 6 Meses
                    </h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white rounded-xl border border-blue-100 p-6 shadow-sm">
                    <h3 className="font-bold text-slate-800 mb-4 flex items-center gap-2">
                        <Library size={18} className="text-blue-600" /> Fundamentaci├│n Te├│rica (Gu├¡as AR)
                    </h3>
                 ...
                 <div className="bg-white rounded-xl border border-emerald-100 p-6 shadow-sm">
                    <h3 className="font-bold text-slate-800 mb-4 flex items-center gap-2">
                        <GraduationCap size={18} className="text-emerald-600" /> Evidencia Cient├¡fica (Papers)
                    </h3>
                    <div className="space-y-3">
      ...
      <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex flex-col md:flex-row justify-between md:items-center gap-4">
        ...
        <div className="flex items-center gap-6 bg-slate-50 p-4 rounded-lg border border-slate-100">
            <div className="text-center">
                <div className="text-xs text-slate-500 font-semibold uppercase">Prob. Internaci├│n (30d)</div>
      ...
      <div className="border-b border-slate-200">
        <nav className="-mb-px flex space-x-8" aria-label="Tabs">
          ...
          <button onClick={() => setActiveTab('timeline')} className={`${activeTab === 'timeline' ? 'border-blue-500 text-blue-600' : 'border-transparent text-slate-500 hover:text-slate-700 hover:border-slate-300'} whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm flex items-center gap-2`}>
             <History size={16} /> Timeline Cl├¡nica (Anti-Leakage)
          </button>
        </nav>
      </div>
          ...
          {activeTab === 'timeline' && (
              <div className="bg-white rounded-lg border border-slate-200 shadow-sm p-6">
                 <h3 className="text-sm font-bold text-slate-700 mb-6 flex items-center gap-2">
                    <CalendarDays size={16} /> Eventos Hist├│ricos (Features)
                 </h3>
        ...
        <div className="space-y-6">
            <div className={`p-6 rounded-xl border shadow-sm relative overflow-hidden bg-gradient-to-b from-indigo-50 to-white border-indigo-100`}>
                ...
                <p className="text-sm mb-6 relative z-10 leading-relaxed text-indigo-700">
                   An├ílisis de riesgo basado en "Eventos Duros" y "Vac├¡o de Datos".
                </p>
...
const App = () => {
  ...
  const handleAddPatient = (data: any) => {
      ...
      alert("Paciente agregado exitosamente (Simulaci├│n)");
  };
      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-30 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-18 py-3 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-1 bg-slate-100 p-1.5 rounded-xl border border-slate-200">
             ...
             >
                <Cpu size={16} /> Inteligencia Cl├¡nica
             </button>
          </div>
